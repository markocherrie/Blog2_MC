...
4. There may be limitations to the type of questions that can be asked and the type of answers that can be supplied (e.g. doodles). In relation to the first point, especially in small groups with questions that might be more personal (i.e. related to project) some students might not feel confident having their answers shared among the group, and this should be respected. 
...
6. I would think that spending more time on getting everyone up to speed with the concept of polling and having a few key questions is better than trying to fit in lots of questions (also relates to student [respondent fatigue](https://www.google.com/search?q=response+fatigue&oq=response+fatigue&aqs=chrome..69i57j0l5.2592j0j4&sourceid=chrome&ie=UTF-8)).
