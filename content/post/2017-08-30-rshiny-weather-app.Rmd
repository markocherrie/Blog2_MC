...
Biometerology is the study of the impacts of the weather and climate on human health. The Met Office provide a cold weather [alert](https://www.metoffice.gov.uk/public/weather/cold-weather-alert/#?tab=coldWeatherAlert) to ensure that people with conditions (e.g. COPD) susceptible to the cold can take precautions, based on evidence of spikes in hospital admissions in weeks of [cold weather (below °C)] (http://err.ersjournals.com/content/15/101/185.full). I have noticed Facebook have jumped on the bandwagon by providing weather information to help nudge their users to optimal behaviour choices. I wondered whether I could replicate this type of nudge intervention in an R Shiny application.
